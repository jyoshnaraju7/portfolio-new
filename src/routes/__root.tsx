...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of A. Jyoshna — Data Analyst and B.Tech IoT graduate skilled in Python, SQL, Power BI and IoT systems." },
      { name: "author", content: "A. Jyoshna" },
      { property: "og:title", content: "A. Jyoshna — Data Analyst Portfolio" },
      { property: "og:description", content: "Data Analyst | B.Tech IoT Graduate. Python, SQL, Power BI, IoT." },
